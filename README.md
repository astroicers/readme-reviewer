...
| **R-004** | 限制誠實 | 說了什麼時候**不該**用嗎？**載重宣稱**有時效標記**或機械同步**嗎？（範例 pin／修辭形容／外部連結本體不算——`scope_of_perishable`） |
...
| **craft verdict** | **信「有沒有問題」，不信刻度** | 主判。**盲判實測**（3 位不知情判讀者 × 12 份）：兩兩整體 **86.1%**、R-001 100%、R-005 94.4%；**R-004 69.4%（失穩靶心，0.3.0 已針對性改寫，效果待下輪盲判）** |
...
>
> **2026-09-02 稍後的盲判資料部分補上了這個洞**：3 位不知情判讀者（乾淨判讀包，
> 拿不到作者判定）兩兩整體 86.1%、verdict 分佈四方同為 7 needs-revision——
> 見 [`reviews/2026-09-02-blind-rejudge-020.md`](reviews/2026-09-02-blind-rejudge-020.md)。
> ⚠️ 但那也量出 **R-004 vs 作者只有 47.2%,且離群的是作者**（舊值錨定移植）。
>
