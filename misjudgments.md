...
| 2026-09-02 | 盲判R2×2(D#9/F#8) | R-005 求助管道最低構成 | 主體有六種正形式,管道只有反例 | **contributing guide / 廣播型 Twitter 算不算「去哪問」無定義**——sindre R-005 2:1;F#8 併記:主體名只活在 href、散文匿名時算哪邊。單源併記:E#8(序4/序5 同值)、D#6(陳述須在 README 內?)、D#5(驗證方式的外部排除範圍)、F#9(章節級陳述涵蓋範圍)、E#4(序2 vs 序4 誘因怪象) |
